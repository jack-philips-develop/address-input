...
import {provinceList as Panama_provinceList} from "./options/panama";
import {provinceList as PapuaNewGuinea_provinceList} from "./options/papua-new-guinea";
import {provinceList as Paraguay_provinceList} from "./options/paraguay";
...
import {doSiList as SouthKorea_doSiList} from "./options/south-korea";
...
import {provinceList as Thailand_provinceList} from "./options/thailand";
import {provinceList as Turkey_provinceList} from "./options/turkey";
...
export function LithuaniaFormComponent() {
  ...
  return (<div className='my-4'>
      ...
      <div className='row mx-0 gap-3 justify-content-between'>
        <Input containerClassName='mt-4 col-4 col-lg-3 col-md-3 col-sm-4' id={1} label='Postal code'
               isImportant='true'/>
...
export function MalaysiaFormComponent() {
  ...
  const convertedList = [{id: 1, name: 'Johor'}, {id: 2, name: 'Kedah'}, {id: 3, name: 'Kelantan'}, {
    id: 4,
    name: 'Kuala Lumpur'
  }, {id: 5, name: 'Labuan'}, {id: 6, name: 'Melaka'}, {id: 7, name: 'Pahang'}, {id: 8, name: 'Perak'}, {
    id: 9,
    name: 'Perlis'
  }, {id: 10, name: 'Pulau Pinang'}, {id: 11, name: 'Putrajaya'}, {id: 12, name: 'Sabah'}, {id: 13, name: 'Sarawak'},]
  ...
  return (<div className='my-4'>
      ...
      <Input containerClassName='mt-0' id={1} label=''/>
      <div className='row mx-0'>
        <Input containerClassName='mt-4 col-12 col-lg-8 col-md-8 col-sm-12' id={1} label='Village/Township'
               isImportant='true'/>
      </div>
      <div className='row mx-0'>
        <Input containerClassName='mt-4 me-3 col-6 col-lg-3 col-md-4 col-sm-6' id={1} label='Postal code'
...
export function MexicoFormComponent() {
  ...
  const convertedList = [{id: 1, name: 'Aguascalientes'}, {id: 2, name: 'Baja California'}, {
    id: 3,
    name: 'Baja California Sur'
  }, {id: 4, name: 'Campeche'}, {id: 5, name: 'Coahuila'}, {id: 6, name: 'Colima'}, {id: 7, name: 'Chiapas'}, {
    id: 8,
    name: 'Chihuahua'
  }, {id: 9, name: 'Durango'}, {id: 10, name: 'Mexico City'}, {id: 11, name: 'Guanajuato'}, {
    id: 12,
    name: 'Guerrero'
  }, {id: 13, name: 'Hidalgo'}, {id: 14, name: 'Jalisco'}, {id: 15, name: 'Mexico'}, {
    id: 16,
    name: 'Michoacan'
  }, {id: 17, name: 'Morelos'}, {id: 18, name: 'Nayarit'}, {id: 19, name: 'Nuevo León'}, {
    id: 20,
    name: 'Oaxaca'
  }, {id: 21, name: 'Puebla'}, {id: 22, name: 'Queretaro'}, {id: 23, name: 'Quintana Roo'}, {
    id: 24,
    name: 'San Luis Potosi'
  }, {id: 25, name: 'Sinaloa'}, {id: 26, name: 'Sonora'}, {id: 27, name: 'Tabasco'}, {
    id: 28,
    name: 'Tamaulipas'
  }, {id: 29, name: 'Tlaxcala'}, {id: 30, name: 'Veracruz'}, {id: 31, name: 'Yucatán'}, {id: 32, name: 'Zacatecas'},]
  ...
  return (<div className='my-4'>
      ...
      <div className='row mx-0 gap-3'>
        <Input containerClassName='mt-4 col-4 col-lg-4 col-md-4 col-sm-4' id={1} label='Postal code'
               isImportant='true'/>
...
/** 176 -> 236 **/
export function PalestinianTerritoriesFormComponent() {
...
export function PanamaFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(Panama_provinceList);
...
export function PapuaNewGuineaFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(PapuaNewGuinea_provinceList);
  ...
  return (<div className='my-4'>
    ...
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 me-3 col-6 col-lg-5 col-md-6 col-sm-6' id={1} label='City' isImportant='true'/>
      <Input containerClassName='mt-4 me-3 col-6 col-lg col-md-6 col-sm-6' id={1} label='Postal code'/>
      <div className={'mt-4 mx-0 col-6 col-lg-5'}>
        <Select selectClassName='mb-4' label='Province'
                isImportant={'true'}
                options={provincesList}
                selectedOption={(option) => setSelectedProvince(option)}/>
...
export function ParaguayFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(Paraguay_provinceList);
...
export function PeruFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(Peru_provinceList);
  ...
  return (<div className='my-4'>
    ...
    <Input containerClassName='mt-0' id={1} label=''/>
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 me-3 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='District'
             isImportant={'true'}/>
      <Input containerClassName='mt-4 col-6 col-lg-3 col-md-6 col-sm-6' id={1} label='Postal code'/>
    </div>
    <div className='d-flex mx-0'>
      <div className={'mt-4 mx-0 col-6 col-lg-6'}>
...
export function PhilippinesFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(Philippines_provinceList);
  ...
  return (<div className='my-4'>
    ...
    <Input containerClassName='mt-0' id={1} label=''/>
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 me-3 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='Suburb'/>
      <Input containerClassName='mt-4 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='City'
             isImportant={'true'}/>
    </div>
    <div className='d-flex mx-0'>
...
export function PitcairnIslandsFormComponent() {
...
export function PolandFormComponent() {
...
export function PortugalFormComponent() {
...
export function PuertoRicoFormComponent() {
  ...
  return (<div className='my-4'>
    ...
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 me-3 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='City'
             isImportant={'true'}/>
      <Input containerClassName='mt-4 col-6 col-lg-3 col-md-6 col-sm-6' id={1} label='Zip code'
             isImportant={'true'}/>
    </div>
  </div>)
}

export function QatarFormComponent() {
...
export function RéunionFormComponent() {
...
export function RomaniaFormComponent() {
...
export function RussiaFormComponent() {
  const [selectedRegion, setSelectedRegion] = useState(0);

  function convertRegionsToObjects(list) {
    return list.map((country, index) => ({
      id: index, name: country//?.toLowerCase()
    }))
  }

  const regionsList = convertRegionsToObjects(Russia_regionList);
  ...
  return (<div className='my-4'>
    ...
    <div className='d-flex mx-0'>
      <div className={'mt-4 mx-0 col-6 col-lg-6'}>
        <Select selectClassName='mb-0 col-12' label='Region'
                isImportant={'true'}
                options={regionsList}
                selectedOption={(option) => setSelectedRegion(option)}/>
      </div>
    </div>
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 col-6 col-lg-3 col-md-6 col-sm-6' id={1} label='Postal code'
...
export function RwandaFormComponent() {
...
export function SouthAfricaFormComponent() {
...
export function SouthGeorgiaSouthSandwichIslandsFormComponent() {
...
export function SouthKoreaFormComponent() {
  const [selectedDoSi, setSelectedDoSi] = useState(0);

  function convertDoSisToObjects(list) {
    return list.map((country, index) => ({
      id: index, name: country//?.toLowerCase()
    }))
  }

  const doSisList = convertDoSisToObjects(SouthKorea_doSiList);
  ...
  return (<div className='my-4'>
    ...
    <div className='d-flex mx-0'>
      {/* 💥 todo -> implement below select box by changing do/si option */}
      <Input containerClassName='mt-4 col-6 col-lg-4 col-md-6 col-sm-6' id={1} label='City' isImportant='true'/>
    </div>
    <div className='d-flex mx-0'>
      <div className={'mt-4 mx-0 col-6 col-lg-4'}>
        <Select selectClassName='mb-0 col-12' label='Do/Si'
                isImportant={'true'}
                options={doSisList}
                selectedOption={(option) => setSelectedDoSi(option)}/>
      </div>
    </div>
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 col-6 col-lg-3 col-md-6 col-sm-6' id={1} label='Postal code'
...
export function SouthSudanFormComponent() {
...
export function SpainFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(Spain_provinceList);
...
export function SriLankaFormComponent() {
...
export function StBarthélemyFormComponent() {
...
export function StHelenaFormComponent() {
...
export function StKittsNevisFormComponent() {
  const [selectedIsland, setSelectedIsland] = useState(0);
  ...
  const islandsList = convertIslandsToObjects(StKittsNevis_islandList);
...
export function StLuciaFormComponent() {
...
export function StMartinFormComponent() {
...
export function StPierreMiquelonFormComponent() {
...
export function StVincentGrenadinesFormComponent() {
...
export function SudanFormComponent() {
...
export function SurinameFormComponent() {
  const [selectedProvince, setSelectedProvince] = useState(0);
  ...
  const provincesList = convertProvincesToObjects(Suriname_provinceList);
...
export function SvalbardJanMayenFormComponent() {
  ...
  return (<div className='my-4'>
    ...
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 me-3 col-6 col-lg-3 col-md-6 col-sm-6' id={1} label='Postal code'
             isImportant={'true'}/>
      <Input containerClassName='mt-4 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='Post town' isImportant='true'/>
    </div>
  </div>)
}

export function SwedenFormComponent() {
  ...
  return (<div className='my-4'>
    ...
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 me-3 col-6 col-lg-3 col-md-6 col-sm-6' id={1} label='Postal code'
             isImportant={'true'}/>
      <Input containerClassName='mt-4 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='Post town'
             isImportant='true'/>
    </div>
  </div>)
}

export function SwitzerlandFormComponent() {
...
export function SyriaFormComponent() {
  ...
  return (<div className='my-4'>
    ...
    <Input containerClassName='mt-0' id={1} label=''/>
    <div className='d-flex mx-0'>
      <Input containerClassName='mt-4 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='District' isImportant='true'/>
    </div>
  </div>)
}
...
export function ThailandFormComponent() {
  ...
  const provincesList = convertProvincesToObjects(Thailand_provinceList);
...
export function TimorLesteFormComponent() {
...
export function TurkeyFormComponent() {
  ...
  const provincesList = convertProvincesToObjects(Turkey_provinceList);
