...
export function ThailandFormComponent() {
    ...
    return (
        <div className='my-4'>
            ...
            <Input containerClassName='mt-0' id={1} label='' />
            <div className='row mx-0'>
                <Input containerClassName='mt-4 me-3 col-9 col-lg-6 col-md-6 col-sm-9' id={1} label='Suburb'  />
                <Input containerClassName='mt-4  col-6 col-lg-3 col-md-4 col-sm-6' id={1} label='City' isImportant='true'/>
            </div>
            <div className='row mx-0'>
                <div className='mt-4 col-8 col-lg-5 col-md-5 col-sm-8 px-0'>
                    <div className='d-flex'>
                ...
                <Input containerClassName='mt-4  col-6 col-lg-3 col-md-4 col-sm-6' id={1} label='Postal code' isImportant='true'/>
            </div>
...
export function TristanDaCunhaFormComponent() {
    return (
        <div className='my-4'>
            ...
            <Input containerClassName='mt-4 me-3 col-3 col-lg-3 col-md-3 col-sm-3' id={1} label='Postal Code'  />
...
export function TurkeyFormComponent() {
    ...
    return (
        <div className='my-4'>
            ...
            <Input containerClassName='mt-0' id={1} label='' />
            <div className='row mx-0'>
                <Input containerClassName='mt-4 me-2 col-2 col-lg-2 col-md-2 col-sm-6' id={1} label='Postal code' isImportant='true'/>
                <Input containerClassName='mt-4  me-3 col-6 col-lg-4 col-md-6 col-sm-6' id={1} label='District' isImportant='true' />
                <div className='mt-4 col-3 col-lg-3 col-md-3 col-sm-6 px-0'>
                    <div className='d-flex'>
                        <p className='m-0 p-0 mb-1 text-dark ms-0 label-input'>Province</p>
                        <span className='text-danger'>*</span>
...
export function TurksCaicosIslandsFormComponent() {
    return (
        <div className='my-4'>
            ...
            <Input containerClassName='mt-4 me-3 col-3 col-lg-3 col-md-3 col-sm-3' id={1} label='Postal Code' isImportant='true'  />
    ...
    return (
        <div className='my-4'>
            ...
            <div className='row mx-0'>
                ...
                <Input containerClassName='mt-4 me-3 col-2 col-lg-2 col-md-2 col-sm-2' id={1} label='Zip Code'  />
...
export function USVirginIslandsFormComponent() {
    return (
        <div className='my-4'>
            ...
            <div className='row mx-0'>
                <Input containerClassName='mt-4 me-3 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='City' isImportant='true' />
                <Input containerClassName='mt-4 me-3 col-3 col-lg-3 col-md-3 col-sm-3' id={1} label='Zip Code' isImportant='true'  />
            </div>
        </div>
    )
}
...
export function UkraineFormComponent() {
    ...
    return (
        <div className='my-4'>
            ...
            <Input containerClassName=' me-3 col-3 col-lg-3 col-md-3 col-sm-3' id={1} label='Postal Code' isImportant='true'  />
...
export function UruguayFormComponent() {
    ...
    return (
        <div className='my-4'>
            ...
            <div className='row mx-0'>
                <Input containerClassName='mt-4 me-3 col-2 col-lg-2 col-md-2 col-sm-2' id={1} label='Postal Code'  />
                <Input containerClassName='mt-4 me-3 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='City' isImportant='true' />
                <div className='mt-4 col-3 col-lg-3 col-md-3 col-sm-6 px-0'>
                    <div className='d-flex'>
                        <p className='m-0 p-0 mb-1 text-dark ms-0 label-input'>Province</p>
...
export function UzbekistanFormComponent() {
    return (
        <div className='my-4'>
            ...
            <Input containerClassName='mt-4 me-3 col-6 col-lg-6 col-md-6 col-sm-6' id={1} label='Province' />
        </div>
    )
}
...
export function VenezuelaFormComponent() {
    ...
    return (
        <div className='my-4'>
            ...
            <Input containerClassName='mt-0' id={1} label='' />
            <div className='row mx-0 gap-3'>
                <Input containerClassName='mt-4 col-9 col-lg-6 col-md-6 col-sm-9' id={1} label='City' isImportant='true' />
                <Input containerClassName='mt-4 col-2 col-lg-2 col-md-2 col-sm-9' id={1} label='Postal code' />
